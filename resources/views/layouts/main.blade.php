...
<body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
            ...
            <li class="active bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">person_outline</i><span class="menu-title" data-i18n="Pages">Users</span></a>
                <div class="collapsible-body">
                    <ul class="collapsible collapsible-sub" data-collapsible="accordion">
                        <li class="active"><a href="/"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Page Blank">Agent Travels</span></a>
                        </li>
                        <li class="active"><a href="/customers"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Page Blank">Customers</span></a>
                        </li>
                    </ul>
                </div>
            </li>
    ...
    <footer class="page-footer footer footer-static footer-dark gradient-45deg-indigo-purple gradient-shadow navbar-border navbar-shadow">
        <div class="footer-copyright">
            <div class="container"><span>&copy; 2023 <a href="http://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank">E-Travelize</a> All rights reserved.</span></div>
        </div>
    </footer>
    <!-- END: Footer-->
